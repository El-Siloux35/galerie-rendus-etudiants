...
**Décision de modélisation importante** : la classe est stockée **sur le rendu**, pas sur une fiche étudiant globale. Un même étudiant apparaît donc en « B2 » en 2025 et « B3 » en 2026, ce qui est historiquement juste. On pourra quand même générer une page `/etudiants/lea-martin` qui agrège ses rendus.
...
- **Grain** : overlay SVG `feTurbulence` très léger, qui donne le côté impression N&B.
